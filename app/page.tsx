...
const categories = [
  ...
  { id: "programming", zh: "编程基础", en: "Programming" },
  { id: "development", zh: "软件开发", en: "Software Development" },
  { id: "engineering", zh: "工程实践", en: "Engineering Practice" },
] as const;
const legacyCategoryAliases: Record<string, (typeof categories)[number]["id"]> = {
  "AI 应用": "ai-apps", "AI Applications": "ai-apps",
  "模型原理": "theory", "Model Theory": "theory",
  "编程基础": "programming", Programming: "programming",
  "软件开发": "development", "Software Development": "development",
  "工程实践": "engineering", Engineering: "engineering", "Engineering Practice": "engineering",
};
const categoryLabel = (category: string, zh: boolean) => {
  const id = legacyCategoryAliases[category] ?? category;
  const match = categories.find((item) => item.id === id);
  return match ? (zh ? match.zh : match.en) : category;
};
